...
public class AngerQuestionsFragment extends Fragment {

    private AngerQuestionsViewModel mViewModel;

    private RecyclerView mRecyclerView;

    private QuestionsAdapter mQuestionsAdapter;

    private final String TAG = "AngerQuestionsFragment";


    public interface AngerQuestionsFragmentInterface {
        void onContinueFromAngerQuestions();
    }

    private AngerQuestionsFragmentInterface listener;

    public static AngerQuestionsFragment newInstance() {
        return new AngerQuestionsFragment();
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (AngerQuestionsFragmentInterface) context;
        } catch (Exception ex) {
            throw new ClassCastException("The Activity Must Implements AngerQuestionsFragmentInterface listener!");
        }
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this, new ViewModelFactory(getContext(),
                ViewModelEnum.AngerQuestions)).get(AngerQuestionsViewModel.class);
        ...
        final Observer<Appointment> onUpdateAnswersOfAppointmentSucceed = new Observer<Appointment>() {
            ...
            public void onChanged(Appointment appointment) {
                if (listener != null) {
                    listener.onContinueFromAngerQuestions();
                }
            }
        };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.anger_questions_fragment, container, false);
        ...
        mViewModel.getQuestions(ViewModelEnum.AngerQuestions);
