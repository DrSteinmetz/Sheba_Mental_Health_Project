...
public class Covid19QuestionsViewModel extends ViewModel {
    ...
    private final String TAG = "Covid19QuestionsVM";


    public Covid19QuestionsViewModel(final Context context) {
