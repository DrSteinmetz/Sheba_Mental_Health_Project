...
public class SocialQuestionsViewModel extends ViewModel {
    ...
    private final String TAG = "SocialQuestionsVM";


    public SocialQuestionsViewModel(final Context context) {
