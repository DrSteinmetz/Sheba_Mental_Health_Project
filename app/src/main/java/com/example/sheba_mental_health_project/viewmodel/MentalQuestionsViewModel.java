...
public class MentalQuestionsViewModel extends ViewModel {
    ...
    private final String TAG = "MentalQuestionsVM";


    public MentalQuestionsViewModel(final Context context) {
