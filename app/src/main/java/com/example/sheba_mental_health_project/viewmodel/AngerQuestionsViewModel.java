...
public class AngerQuestionsViewModel extends ViewModel {
    ...
    private final String TAG = "AngerQuestionsViewModel";


    public AngerQuestionsViewModel(final Context context) {
