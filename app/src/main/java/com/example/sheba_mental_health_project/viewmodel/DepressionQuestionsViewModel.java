...
public class DepressionQuestionsViewModel extends ViewModel {
    ...
    private final String TAG = "DepressionQuestionsVM";


    public DepressionQuestionsViewModel(final Context context) {
